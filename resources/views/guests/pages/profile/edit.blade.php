                                                ...
                                                <div class="setting__profile--inner">
                                                    <div class="add__listing--input__box mb-20">
                                                        ...
                                                        <input 
                                                            ...
                                                            type="text" 
                                                            required
                                                            value="{{ old('linkedin_profile', Auth::user()->advisoryProfile->linkedin_profile ?? '') }}">
                                                    ...
                                                    <div class="add__listing--input__box mb-20">
                                                        ...
                                                        <input 
                                                            ...
                                                            type="text" 
                                                            required
                                                            value="{{ old('Twitter Profile', Auth::user()->advisoryProfile->twitter_profile  ?? '') }}">
                                                    ...
                                                    <div class="add__listing--input__box mb-20">
                                                        ...
                                                        <input 
                                                            ...
                                                            type="text" 
                                                            required
                                                            value="{{ old('Facebook Profile', Auth::user()->advisoryProfile->facebook_profile  ?? '') }}">
                                                    ...
                                                    <div class="add__listing--input__box mb-20">
                                                        ...
                                                        <textarea class="add__listing--input__field"  id="bio" name="bio" rows="5">{{ old('bio', Auth::user()->advisoryProfile->bio ?? '') }}</textarea>
                                                          @error('bio')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                    ...
                                                    <div class="add__listing--input__box mb-20">
                                                        ...
                                                        type="text" 
                                                        required
                                                        value="{{ old('expertise', Auth::user()->advisoryProfile->expertise  ?? '') }}">
                                                    ...
                                                    <div class="add__listing--input__box mb-20">
                                                        ...
                                                        required
                                                        type="number" 
                                                        value="{{ old('years_of_experience', Auth::user()->advisoryProfile->years_of_experience  ?? '') }}">
