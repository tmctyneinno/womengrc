    ...
    <div class="dashboard__sidebar--inner">
        <ul class="sidebar__menu" id="accordionExample">
            <li class="sidebar__menu--items">
                <a class="sidebar__menu--link active" href="{{ route('facilitator.dashboard')}}">
            ...
            <li class="sidebar__menu--items">
                <a class="sidebar__menu--link" href="{{ route('facilitator.create.event')}}">
                    ...
                    <span class="sidebar__menu--text">Create Event </span>
                </a>
            </li>
