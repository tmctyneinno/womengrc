                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                ...
                                <form method="POST"  action="{{ route('admin.resource.store') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="mb-3 row align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                            <input id="image" type="file" class="form-control @error('image') is-invalid @enderror" name="image" required onchange="previewImage(resource)">
                                            @error('image')
