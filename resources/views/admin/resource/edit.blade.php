                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                ...
                                <form method="POST"  action="{{ route('admin.resource.update', $resource->id) }}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="mb-3 row align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                            <input id="image" type="file" class="form-control @error('image') is-invalid @enderror" name="image" onchange="previewImage(resource)">
                                            @error('image')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                            @enderror
                                            <img src="{{ asset($resource->image) }}" alt="{{ $resource->title }}" class="img-thumbnail mt-2" width="200">
                                ...
                                <script>
                                    ...
                                    function previewImage(resource) {
                                        const input = resource.target;
