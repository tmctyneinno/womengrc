    ...
    <div class="content-body">
        ...
        <div class="container-fluid">
            <div class="form-head d-md-flex mb-sm-4 mb-3 align-items-start">
                ...
                <a href="{{route('admin.membership.plan.index')}}" class="btn btn-primary rounded light">View Membership Plans </a>
            </div>
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                ...
                                <div class="compose-content">
                                    <form method="POST" action="{{ route('admin.membership.plan.update', $plan->id) }}" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="mb-3 row align-items-center">
                                            ...
                                            <div class="col-sm-9"> 
                                                <select class="form-select" name="type" id="type" required>
                                                    <option value="individual" {{ $plan->type == 'individual' ? 'selected' : '' }}>Individual</option>
                                        ...
                                        <div class="mb-3 row align-items-center">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" name="target_audience" rows="4" required>{{ old('target_audience', $plan->target_audience) }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 row align-items-center">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" name="key_benefits" rows="4" required>{{ old('key_benefits', $plan->key_benefits) }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 row align-items-center">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" class="form-control" placeholder="0.00" name="annual_fee" 
                                                    step="0.01" min="0" value="{{ old('annual_fee', $plan->annual_fee) }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="text-start mt-4 mb-2">
                                            <button class="btn btn-primary btn-sl-sm me-2" type="submit">
                                                <span class="me-2">Update Plan</span>
                                            </button>
                                        </div>
                                    </form>
                                </div>
