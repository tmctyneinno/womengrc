                                ...
                                <div class="compose-content">
                                    <form method="POST" action="{{ route('admin.membership.plan.store') }}" enctype="multipart/form-data" class="">
                                        ...
                                        <div class="mb-3 row align-items-center">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea cols="4" type="text" class="form-control" name="description" id="video_link" required></textarea>
                                        ...
                                        <div class="mb-3 row align-items-center">
                                            <label class="col-sm-3 col-form-label form-label">Billing Period</label>
                                            <div class="col-sm-9">
                                                <select class="form-select" name="billing_period" id="billing_period" required>
