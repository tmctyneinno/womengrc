        ...
        <div class="container-fluid">
            <div class="form-head d-md-flex mb-sm-4 mb-3 align-items-start">
                <div class="me-auto d-lg-block d-block">
                    <h2 class="text-black font-w600">Event</h2>
                    <p class="mb-0">Welcome to Archway Home backend</p>
                </div>
                <a href="{{route('admin.event.index')}}" class="btn btn-primary rounded light">View Event</a>
            </div>
                            ...
                            <div class="basic-form">
                                ...
                                <form method="POST"  action="{{ route('admin.event.update', $event->id) }}" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3 row align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="">
                                                <textarea name="content" id="ckeditor" class="form-control" required>{{ $event->content }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            @enderror
                                            <img src="{{ asset($event->image) }}" alt="{{ $event->title }}" class="img-thumbnail mt-2" width="200">
