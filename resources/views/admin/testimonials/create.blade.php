                            ...
                            <div class="basic-form">
                                ...
                                <form method="POST"  action="{{ route('admin.testimonials.store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3 row align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" placeholder="Author name" name="author_name" id="author_name" autocomplete="off" required autofocus>
                                        </div>
                                    </div>
                                    <div class="mb-3 row align-items-center">
                                        <label class="col-sm-3 col-form-label form-label">Author Title</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" placeholder="Author title" name="author_title" id="author_name" autocomplete="off" required autofocus>
                                        </div>
                                    </div>
