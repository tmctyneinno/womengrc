        ...
        <div class="container-fluid">
            <div class="form-head d-md-flex mb-sm-4 mb-3 align-items-start">
                <div class="me-auto d-lg-block d-block">
                    <h2 class="text-black font-w600">Advisory Board Member</h2>
                    <p class="mb-0">Welcome to Archway Home backend</p>
                </div>
                <a href="{{route('admin.advisoryBoardMember.index')}}" class="btn btn-primary rounded light">View Advisory BoardM ember</a>
            </div>
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-12 align-center">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Add Advisory Board Member</h4>
                        </div>
                        <div class="card-body">
                            <div class="basic-form">
                                ...
                                <form method="POST"  action="{{ route('admin.advisoryBoardMember.store') }}" enctype="multipart/form-data">
                                    @csrf
