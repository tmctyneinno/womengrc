                ...
                <div class="col-xl-6 col-lg-12 align-center">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Add Recognition</h4>
                        </div>
                        <div class="card-body">
                            <div class="basic-form">
                                ...
                                <form method="POST"  action="{{ route('admin.recognition.store') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="mb-3 row">
                                        <div class="col-sm-10">
                                            <button type="submit" class="btn btn-primary">Create Recognition</button>
                                        </div>
                                    </div>
